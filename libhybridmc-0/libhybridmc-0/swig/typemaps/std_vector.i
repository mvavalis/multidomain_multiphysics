...
{
  // OUT_TYPEMAP_STD_VECTOR_OF_PRIMITIVES(int, NPY_INT32)
  npy_intp adims = $1.size();
  ...
  else if (sizeof(int) == 8)
  {
    ...
    SWIG_exception(SWIG_TypeError, "sizeof(int) incompatible NumPy types");
...
// Need specialized typemap for int
//OUT_TYPEMAP_STD_VECTOR_OF_PRIMITIVES(int, dolfin_index)
...
// This typemap handles int, which can be a 32 or 64 bit integer
OUT_TYPEMAP_STD_VECTOR_OF_PRIMITIVES_REFERENCE(int, dolfin_index)
