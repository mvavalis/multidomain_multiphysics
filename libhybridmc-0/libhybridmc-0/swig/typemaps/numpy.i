...
UNSAFE_NUMPY_TYPEMAPS(int,INT32,NPY_UINT,dolfin_index,intc)
...
NUMPY_ARRAY_FRAGMENTS(std::size_t, NPY_UINTP, size_t)
 ...
 //NUMPY_ARRAY_FRAGMENTS(int, NPY_INT, dolfin_index)
 //NUMPY_ARRAY_FRAGMENTS(int, NPY_INT64, dolfin_index)
